...
- Prints all test metrics and runtime separately
- Uses GradViz for gradient visualization and Netron for model visualization
"""
...
# Print all test metrics and runtime:
...
print(f"Runtime    : {test_runtime:.2f} seconds")
print("============================\n")
